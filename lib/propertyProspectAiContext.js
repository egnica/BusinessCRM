...
const RESEARCH_INSTRUCTIONS = {
  objective:
    "Build a well-sourced understanding of the owner as a person, the business and property story around them, and whether they appear to have an established succession path. Give special attention to identifying prospects where no clear successor is publicly evident, because Nicholas may ultimately hope to become a trusted future successor. A lack of a clear successor is an opportunity signal; a credible established successor is a deprioritizing signal.",
  draftGate:
  ...
  workflow: [
    ...
    "Perform the dedicated successor investigation described below. The goal is not merely to find a successor; it is to determine whether a credible successor already exists. Treat no clear successor as a potentially strong opportunity signal for Nicholas, while treating a credible established successor as a negative prospect signal.",
  ...
  successorInvestigation: {
    purpose:
      "Determine whether there is a credible person or entity positioned to continue, inherit, manage, acquire, or otherwise assume responsibility for the owner's properties or business. The practical objective is to identify owners who do not appear to have an established successor, because Nicholas may ultimately hope to become a trusted future successor. Finding a credible successor is therefore not automatically positive; it usually lowers succession opportunity. Rank supported candidates and explain the likely succession path without converting family relationships into unsupported inheritance claims.",
    opportunityScoring: {
      high:
        "No credible successor or transition path is publicly identified after reasonable research. This is a strong positive prospect signal for Nicholas, while still acknowledging that a private succession plan may exist.",
      medium:
        "Succession is unclear, weakly supported, or only speculative. This remains a positive-to-neutral opportunity signal and merits respectful relationship building.",
      low:
        "A credible established successor, active transition plan, or clear next-generation or internal continuity path exists. This is a negative prospect signal for Nicholas as a potential future successor.",
    },
    lookFor: [
    ...
    requiredAssessment: [
      ...
      "Score Succession Opportunity as high, medium, or low from Nicholas's perspective: high when no credible successor is found, medium when succession is unclear or weakly supported, and low when a credible established successor or transition plan exists.",
      "Explain which evidence drove the Succession Opportunity score and distinguish no public evidence from proof that no private succession plan exists.",
  ...
  briefingRequirements: [
    "Begin with a concise conclusion covering identity confidence, owner and business assessment, property context, contactability, Succession Opportunity score, whether a credible successor exists, the strongest reason to pursue or deprioritize the prospect, the main uncertainty, and the recommended next step.",
    ...
    "A dedicated successor assessment with the Succession Opportunity score, ranked candidates, separate relationship and operational evidence, confidence, likely continuity path, alternative candidates, unknowns, and a respectful confirmation question.",
...
export function buildPropertyProspectAiContext(prospect) {
  ...
  return {
    ...
    schemaVersion: 6,
    task: "Enrich missing or uncertain record fields, research this owner and their business deeply using current public sources, and determine whether a credible successor already exists, with special emphasis on identifying owners who do not appear to have a clear successor. Begin with a concise conclusion that includes a Succession Opportunity score, then provide sourced proposed updates, conflicts, leads to verify, the full research briefing, and a ranked successor assessment. Treat no clear successor as a positive opportunity signal for Nicholas and a credible established successor as a negative signal. Make no CRM changes and draft nothing until Nicholas explicitly approves the next step.",
    owner: {
