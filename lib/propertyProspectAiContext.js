...
const RESEARCH_INSTRUCTIONS = {
  ...
  workflow: [
    ...
    "Perform the succession and family-continuity research described below.",
  ...
  successionAndFamilyEvidence: {
    purpose:
      "Look for credible public evidence of relatives, co-owners, business colleagues, or named successors who may be relevant to the future continuity of the owner's properties or business.",
    lookFor: [
      "Relatives publicly involved in the same property, LLC, company, or professional work.",
  ...
  briefingRequirements: [
    ...
    "Succession and family-continuity evidence, including when no credible evidence was found.",
...
export function buildPropertyProspectAiContext(prospect) {
  ...
  return {
    ...
    schemaVersion: 4,
    task: "Research this owner deeply using current public sources. Bring Nicholas a sourced research briefing and discuss the outreach strategy before drafting anything. Draft only after explicit approval.",
    owner: {
