...
export function buildPropertyProspectAiContext(prospect) {
  ...
  return {
    ...
    workflow: {
      ...
      step4:
        "Do not produce the final letter until I explicitly say I am ready to draft it. When I approve the draft, return the letter as clean body-level HTML that can be pasted directly into the CRM Letter HTML editor.",
      researchBoundaries: [
    ...
    outputPreference: {
      ...
      length: "short",
      htmlRequirements: [
        "Return only the letter body HTML when the final draft is requested.",
